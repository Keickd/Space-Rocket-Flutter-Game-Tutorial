...
import 'package:space_rocket/components/bomb.dart';
import 'package:space_rocket/components/explosion.dart';
import 'package:space_rocket/components/laser.dart';
import 'package:space_rocket/components/pickup.dart';
import 'package:space_rocket/components/shield.dart';
...
class Player extends SpriteAnimationComponent
  ...
  void _handleDestruction() async {
    ...
    add(RotateEffect.by(
        _random.nextInt(7) - 3, EffectController(duration: 3.0)));
